...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-edge/node_modules/edge/samples/209_websocket.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-edge/node_modules/edge/samples/209_websocket.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-edge/node_modules/edge/samples/</a> &#187; 209_websocket.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// Overview of edge.js: http://tjanczuk.github.io/edge
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var createMyNetWebSocket = edge.func(<span class="fstat-no" title="function not covered" >function () {</span>/*</span>
    using System;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >var wss = new WebSocketServer({ server : server });</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    var sendImpl = <span class="fstat-no" title="function not covered" >function (message, callback) {</span></span>
<span class="cstat-no" title="statement not covered" >        ws.send(message);</span>
<span class="cstat-no" title="statement not covered" >        callback();</span>
    };
&nbsp;
<span class="cstat-no" title="statement not covered" >    var receiveHandler = createMyNetWebSocket(sendImpl, true);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    ws.on('message', <span class="fstat-no" title="function not covered" >function (message) {</span></span>
<span class="cstat-no" title="statement not covered" >        receiveHandler(message);</span>
    });
});
&nbsp;
<span class="cstat-no" title="statement not covered" >server.listen(process.env.PORT || 8080);</span>
&nbsp;</pre></td></tr>
</table></pre>
</div>
<div class="footer">
